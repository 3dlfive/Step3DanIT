...
(function () {
  ...
  var a = /*#__PURE__*/function () {
    ...
    _createClass(a, [{
      ...
      value: function renederEdit(e) {
        ...
        v.classList.add("modal-area__visit-fields"), "Therapist" === e.doctor && (_a2.classList.add("modal-area__modalEdit-input"), _a2.value = e.age, v.append(_a2)), "Dentist" === e.doctor && (o.classList.add("modal-area__modalEdit-input"), o.setAttribute("onfocus", "this.type='date'"), o.value = e.dateOfLastVisit, v.append(o)), "Cardiologist" === e.doctor && (_a2.classList.add("modal-area__modalEdit-input"), n.classList.add("modal-area__modalEdit-input"), i.classList.add("modal-area__modalEdit-input"), d.classList.add("modal-area__modalEdit-input"), r.classList.add("modal-area__modalEdit-input"), _a2.value = e.age, n.value = e.systolicPressure, i.value = e.diastolicPressure, d.value = e.bmi, r.value = e.cardiovascularDiseases, v.append(_a2, i, n, d, r));
        var p = [l, m, c, u, h, t];
        ...
        b.classList.add("modal-area__editvisitbtn"), b.innerText = "Сохранить", this.container = document.querySelector(".modal-body"), this.container.append(v, b), b.addEventListener("click", function () {
          ...
          "Cardiologist" === e.doctor && fetch("https://ajax.test-danit.com/api/v2/cards/".concat(e.id), {
            ...
            if (e.status >= 200 && e.status < 300) return e;
            {
              var _t12 = new Error(e.statusText);

              throw _t12.response = e, _t12;
            }
          }).then(function (e) {
            return e.json();
          }).then(function (e) {
  ...
  window.addEventListener("load", function () {
    d = localStorage.getItem("token"), d && (document.querySelector("#entry-btn").classList.add("hidden"), document.querySelector("#visit-btn").classList.remove("hidden"), document.querySelector("#logout-btn").classList.remove("hidden"), l = JSON.parse(localStorage.getItem("allVisits")), new s().init());
  }), document.addEventListener("click", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(t) {
      var _n2, _i, _a5, _t15, a;
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return function (t, s, a) {
                ...
                e && "object" != _typeof(e) ? (localStorage.setItem("token", e), d = localStorage.getItem("token"), r.close()) : r.invalid();
              })["catch"](function (e) {
            ...
            case 13:
              ...
              _context2.next = 22;
              return (a = d, e.apply(void 0, ["https://ajax.test-danit.com/api/v2/cards"].concat(_arrayWithoutHoles([,,]), [{
                headers: {
